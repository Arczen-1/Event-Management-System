...
const ContractSchema = new mongoose.Schema(
  {
    ...
    pageBuffet: {
      ...
      upgradeFish200Selections: { type: [String], default: [] },
      upgradeFish225Selections: { type: [String], default: [] },
      mainSeafoodSelections: { type: [String], default: [] },
      mainChickenSelections: { type: [String], default: [] },
      upgradeChicken95Selections: { type: [String], default: [] },
      upgradeChicken100Selections: { type: [String], default: [] },
      upgradeChicken110Selections: { type: [String], default: [] },
      mainPastaSelections: { type: [String], default: [] },
      mainNoodlesSelections: { type: [String], default: [] },
      mainVegSideDishSelections: { type: [String], default: [] },
