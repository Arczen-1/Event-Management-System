// Shared constants for ContractForm components
...
export const UPGRADE_SOUP_OPTIONS = [
  "Broccoli Soup",
  "Bouillabaisse Soup",
...
export const MAIN_BEEF_OPTIONS = [
  "Pot Roast Beef",
...
export const MAIN_PORK_OPTIONS = [
...
export const UPGRADE_PORK_200_OPTIONS = [
  "Baby Back Ribs"
];

export const UPGRADE_PORK_250_OPTIONS = [
  "Cinnamon Honey Glazed Pork Paupiette Wrapped in Bacon Stuffed with Garlic River Spinach"
];

export const UPGRADE_PORK_275_OPTIONS = [
  "Oven Roasted Pig with Liver Sauce"
];

export const UPGRADE_PORK_15000_OPTIONS = [
...
export const MAIN_NOODLES_OPTIONS = [
  "Pad Thai",
  "Mac and Cheese"
];
...
export const OYSTER_BAR_OPTIONS = [
...
export const APPETIZER_UPGRADE_125_OPTIONS = [
  "Baked Hokkaido Scallop with Pastis Prado Wine in Paprika Cream Sauce",
  "Escargot A ‘La Bourguignonne"
];

export const APPETIZER_UPGRADE_150_OPTIONS = [
...
export const SALAD_UPGRADE_125_OPTIONS = [
  "Crunchy Apple Salad",
  "Waldorf Salad",
  "Russian Salad",
...
export const SALAD_UPGRADE_150_OPTIONS = [
  "Panzanella Salad",
  "European Salad",
