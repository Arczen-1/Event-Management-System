    ...
    return (
      <div className="contracts-table-container">
        <div className="table-header">
          ...
          <h3>Contracts for Linen Review</h3>
          <div className="pager">
            ...
            <div className="contract-details">
              ...
              <div className="detail-section">
                ...
                <div className="detail-row">
                 ...
                 <div className="detail-row">
                  <strong>Regular Table Quantity:</strong> {selectedContract.page1?.regularTableQuantity || "N/Good"}
                </div>
                 <div className="detail-row">
                  <strong>Cake Table (Flowers):</strong> {selectedContract.page2?.flowerCakeTable || "N/A"}
                </div>
              </div>

              <div className="detail-section">
                <h4>Linen Requirements</h4>
                <div className="detail-row">
                  <strong>VIP Table Underliner:</strong> {selectedContract.page1?.vipUnderliner || "N/A"}
                </div>
                <div className="detail-row">
                  <strong>VIP Table Topper:</strong> {selectedContract.page1?.vipTopper || "N/A"}
                </div>
                <div className="detail-row">
                  <strong>VIP Table Napkin:</strong> {selectedContract.page1?.vipNapkin || "N/A"}
                </div>
                <div className="detail-row">
                  <strong>Guest Table Underliner:</strong> {selectedContract.page1?.guestUnderliner || "N/A"}
                </div>
                <div className="detail-row">
                  <strong>Guest Table Topper:</strong> {selectedContract.page1?.guestTopper || "N/A"}
                </div>
                <div className="detail-row">
                  <strong>Guest Table Napkin:</strong> {selectedContract.page1?.guestNapkin || "N/A"}
                </div>
              </div>
            </div>
          )}
